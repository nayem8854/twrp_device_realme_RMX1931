...
FOX_TARGET_DEVICES := samurai,RMX1931,RMX1931CN,RMX1931L1,realmeX2Pro
...
# Keymaster & Decryption (fixes: TW_FORCE_KEYMASTER_VER requires OF_DEFAULT_KEYMASTER_VERSION)
OF_DEFAULT_KEYMASTER_VERSION := 4.0
OF_KEEP_FORCED_KEYMASTER := true

# OrangeFox Features & Utilities
OF_USE_MAGISKBOT := 1
OF_USE_NEW_MAGISKBOT := 1
